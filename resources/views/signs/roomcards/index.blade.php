		...
		<div class="col">
			<div class="d-flex flex-column h-100">
				...
				<div class="row no-gutters flex-grow-1 event-table">
					<div class="col">
						<div class="d-flex flex-column h-100">
							<room-card-caption v-bind:room-card-area="'{{ $sign->signArea->area_guid }}'" v-bind:database="{{ $sign->database_id }}"></room-card-caption>
							...
							<room-card-body v-bind:room-card-area="'{{ $sign->signArea->area_guid }}'" v-bind:database="{{ $sign->database_id }}"></room-card-body>
						</div>
					</div>
				</div>
			</div>
